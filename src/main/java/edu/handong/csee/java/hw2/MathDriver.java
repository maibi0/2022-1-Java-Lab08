...
/**
 * MathDriver class contains the code to run the calculator, importing the formulas for it's functions from MathCalculator class.
 */
public class MathDriver {
    /**
    * Main method that initializes the driver for the calculator and calls the run method to start the calculator.
    */
    ...
    /**
    * Run method that initializes the actual calculator and determines what functions to call through a switch case.
    */
